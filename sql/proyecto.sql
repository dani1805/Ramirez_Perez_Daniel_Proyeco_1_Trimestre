...
ALTER TABLE `comments`
  ...
  /* He añadido ambas lineas porque no se pueden borrar comentarios que tiene post asociados*/

ALTER TABLE `posts`
  ADD CONSTRAINT `posts_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

  /* He añadido ambas lineas porque no se pueden borrar posts que tiene usuarios asociados*/